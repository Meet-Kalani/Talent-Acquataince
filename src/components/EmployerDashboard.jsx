        ...
        <table border="1">
            ...
            <tbody>
                            <tr>
                                ...
                                <td><span onClick={()=>{history.push({pathname:'/Talent-Acquataince/employer/review-application',state:{job_id:location.state.job_id,candidate_id:candidates._id}})}}>View Application -></span></td>
                            </tr>
            </tbody>
        </table>
    </div>
